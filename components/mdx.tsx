...
export const H1 = ({ children }: React.HTMLProps<HTMLHeadingElement>) => (
  <CustomHeading
    className="text-3xl font-display font-bold normal-case tracking-tight text-gray-900 sm:text-4xl dark:text-gray-50"
    level={1}
  >
    {children}
  </CustomHeading>
...
export const H2 = ({ children }: React.HTMLProps<HTMLHeadingElement>) => (
  <CustomHeading
    className="mb-4 text-lg font-display font-semibold normal-case tracking-tight text-gray-900 dark:text-gray-50"
    level={2}
  >
    {children}
  </CustomHeading>
...
export const H3 = ({ children }: React.HTMLProps<HTMLHeadingElement>) => (
  <CustomHeading
    className="mb-2 font-display font-semibold normal-case tracking-tight text-gray-900 dark:text-gray-50"
    level={3}
  >
    {children}
  </CustomHeading>
...
export const P = ({ ...props }) => (
  <p {...props} className="mb-8 font-text leading-7 text-muted-foreground" />
)

export const UL = ({ ...props }) => (
  <ul
    {...props}
    className="mb-10 ml-[30px] font-text list-['–__'] space-y-1 leading-8 text-muted-foreground"
  />
)

export const Strong = ({ ...props }) => (
  <span className="font-display font-semibold text-gray-900 dark:text-gray-50" {...props} />
)
