      ...
      >
        ...
        >
          ...
          <div className="flex items-center gap-4">
            ...
            <p className="font-display font-semibold tracking-tight text-gray-700 transition-all group-data-[state=active]:text-indigo-600 sm:text-lg dark:text-gray-400 dark:group-data-[state=active]:text-indigo-400">
              Backend
            </p>
          </div>
          <p className="mt-4 font-text leading-7 text-muted-foreground">
            A performant backend built with FastAPI and Supabase.
          </p>
        </Tabs.Trigger>
        <Tabs.Trigger
          className="group relative flex flex-1 flex-col items-start justify-start rounded-xl p-6 text-left shadow-lg ring-1 ring-gray-200 dark:ring-white/5 dark:data-[state=active]:shadow-indigo-900/30"
