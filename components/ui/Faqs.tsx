    ...
    <section className="mt-20 sm:mt-36" aria-labelledby="faq-title">
      <div className="grid grid-cols-1 lg:grid-cols-12 lg:gap-14">
        <div className="col-span-full sm:col-span-5">
          <h2
            id="faq-title"
            className="inline-block scroll-my-24 bg-gradient-to-br from-foreground to-base-800 bg-clip-text py-2 pr-2 text-2xl font-display font-bold tracking-tighter text-transparent lg:text-3xl"
          >
            Frequently Asked Questions
          </h2>
          <p className="mt-4 text-base leading-7 text-muted-foreground font-text">
          ...
          <Accordion type="multiple" className="mx-auto">
            {faqs.map((item) => (
              ...
              >
                ...
                <AccordionContent className="text-muted-foreground font-text">
                  {item.answer}
                </AccordionContent>
              </AccordionItem>
            ))}
